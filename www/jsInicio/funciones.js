    ...
    try {
        ...
        eventosMeet.forEach((evento) => {
            columnas += `
                <div class="col-3">
                    <div class="zoom-img">
                        <button type="button" class="btn p-0 border-0 bg-transparent" data-bs-toggle="modal" data-bs-target="#evento-${evento.id}">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-primary btn-programar-alerta" data-event-id="${evento.id}">Programar Alerta</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal fade" id="modal-${btoa(imagen)}" tabindex="-1" aria-labelledby="label-${btoa(imagen)}" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                               <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                               <button type="button" class="btn btn-primary btn-programar-alerta">Programar Alerta</button>
                            </div>
                        </div>
                    </div>
                </div>
...
export function modalMapa(datosEventos, datosStands) {
    ...
    // Configurar eventos de click en áreas del mapa
